...
load(loadname);
name2 = '_Leaders_SL';
endname = strcat(name, name2,'.mat');
figurename = strcat(name, name2);
...
figure('Name',strcat('Timepoint',num2str(i)),'NumberTitle','off')
...
saveas(h,strcat(figurename,'_t',num2str(i),'.png'));
...
%%
% %set up movie
% writerObj=VideoWriter('w54_fast.avi');
